...
| POSTGRESQL_DB_URL                 | PostgreSQL database URL server (jdbc:postgresql://localhost:5432/dbnamehere). If not informed, then system will use the container address 'pgserver'. | pgserver          |
